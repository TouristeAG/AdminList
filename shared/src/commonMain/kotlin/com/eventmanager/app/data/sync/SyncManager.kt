...
class SyncManager(
    ...
    private val twoWaySyncService = TwoWaySyncService(platformContext, repository, googleSheetsService)
    private val settingsManager = SettingsManager(createAppStorage(platformContext))
    private val dataStructureValidator = DataStructureValidator(platformContext, googleSheetsService)
