            ...
            scope.launch(Dispatchers.IO) {
                try {
                    ...
                    val file = if (pendingExportType == ExportType.XLSX) {
                        GraphExportAndroid.exportToXLSX(
                            context = context,
                            title = context.getString(R.string.active_volunteers),
                            dataPoints = dataPoints,
                            trendPoints = trendPoints,
                        ...
                        GraphExportAndroid.exportToJPG(context, graphBitmap, context.getString(R.string.active_volunteers))
                    }
            ...
            scope.launch(Dispatchers.IO) {
                try {
                    ...
                    val file = if (pendingExportType == ExportType.XLSX) {
                        ...
                        GraphExportAndroid.exportToJPG(context, graphBitmap, title)
                    }
            ...
            scope.launch(Dispatchers.IO) {
                try {
                    ...
                    genderData.segments.forEachIndexed { index, segment ->
                        ...
                        val graphBitmap = GraphExportAndroid.renderPieChartAsBitmap(
                            segments = segments,
                            title = context.getString(R.string.gender_distribution)
                        )
                        
                        val file = GraphExportAndroid.exportToJPG(
                            context = context,
                            bitmap = graphBitmap,
                            title = context.getString(R.string.gender_distribution)
                        )
            ...
            scope.launch(Dispatchers.IO) {
                try {
                    ...
                    val file = if (pendingExportType == ExportType.XLSX) {
                        ...
                        GraphExportAndroid.exportToJPG(context, graphBitmap, label)
                    }
